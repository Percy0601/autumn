...
public class ClassResolverUtil {
    ...
    public static TargetClass handleReference(Element annotatedClass) {
        log.info("begin handle annotation Reference:{}", annotatedClass.getSimpleName().toString());
        ...
        log.info("=====================Export:{}", targetClass);
        return targetClass;
    }

    public static TargetClass handleExport(Element annotatedClass) {
        ...
        log.info("=====================Reference:{}", targetClass);
        return targetClass;
    }
